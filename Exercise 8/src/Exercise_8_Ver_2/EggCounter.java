...
public class EggCounter {
	...
	private String[] eggSizeNames = { "too small", "peewee", "small", "medium", "large", "extra-large", "jumbo",
			"too large" };
	...
	/*
	 * Interacts with the user using a loop to obtain egg weights one at a time,
	 * increments appropriate eggCounter array element. Exits loop when a sentinel
	 * value is entered.
	 */
	...
	/*
	 * Decides the egg size based on weight and returns a value to represent this.
	 * The number returned is suitable as an array index. Updated Version 2: uses
